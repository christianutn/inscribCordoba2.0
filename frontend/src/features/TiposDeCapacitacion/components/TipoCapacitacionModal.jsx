...
const TipoCapacitacionModal = ({ open, onClose, onSave, initialData }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            <DialogTitle sx={{ m: 0, p: 2 }}>
                {isEditMode ? 'Editar Tipo de Capacitación' : 'Nuevo Tipo de Capacitación'}
                <IconButton
                    aria-label="close"
                    onClick={onClose}
                    sx={{
...
export default TipoCapacitacionModal;
