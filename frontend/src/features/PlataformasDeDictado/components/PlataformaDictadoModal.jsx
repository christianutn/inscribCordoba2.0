...
const PlataformaDictadoModal = ({ open, onClose, onSave, initialData }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            <DialogTitle sx={{ m: 0, p: 2 }}>
                {isEditMode ? 'Editar Plataforma de Dictado' : 'Nueva Plataforma de Dictado'}
                <IconButton
                    aria-label="close"
                    onClick={onClose}
                    sx={{
...
export default PlataformaDictadoModal;
