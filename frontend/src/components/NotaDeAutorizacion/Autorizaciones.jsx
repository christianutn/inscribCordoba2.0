...
import {
  getUltimosEstadoDeAutorizaciones,
  rechazarNotaDeAutorizacion,
} from "../../services/cambiosEstadoAutorizacion.service.js";
...
const Autorizaciones = () => {
  ...
  const handleRefreshAutorizaciones = () => {
    setAlert({
      open: true,
      message:
    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default", py: 4 }}>
      ...
      <Container maxWidth={false} sx={{ px: { xs: 2, md: 5 } }}>
        ...
        <ModalCargarNota
          ...
          onSuccess={handleRefreshAutorizaciones}
        />
      </Container>
    </Box>
  );
